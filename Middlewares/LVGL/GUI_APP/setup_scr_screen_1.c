...
void setup_scr_screen_1(lv_ui *ui)
{
	...
	lv_obj_set_style_bg_color(ui->screen_1, lv_color_hex(0x91d0ff), LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_label_set_text(ui->screen_1_btn_1_label, "LIUS");
	...
	lv_obj_set_style_text_font(ui->screen_1_btn_1, &lv_font_arial_36, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->screen_1_btnm_1, 69, 487);
	lv_obj_set_size(ui->screen_1_btnm_1, 335, 267);
	...
	lv_obj_set_style_bg_opa(ui->screen_1_btnm_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_color(ui->screen_1_btnm_1, lv_color_hex(0xfafafa), LV_PART_ITEMS|LV_STATE_DEFAULT);
	lv_obj_set_style_text_font(ui->screen_1_btnm_1, &lv_font_Alatsi_Regular_24, LV_PART_ITEMS|LV_STATE_DEFAULT);
	lv_obj_set_style_text_opa(ui->screen_1_btnm_1, 255, LV_PART_ITEMS|LV_STATE_DEFAULT);
	lv_obj_set_style_radius(ui->screen_1_btnm_1, 27, LV_PART_ITEMS|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_opa(ui->screen_1_btnm_1, 255, LV_PART_ITEMS|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_color(ui->screen_1_btnm_1, lv_color_hex(0x91b5fe), LV_PART_ITEMS|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_grad_dir(ui->screen_1_btnm_1, LV_GRAD_DIR_HOR, LV_PART_ITEMS|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_grad_color(ui->screen_1_btnm_1, lv_color_hex(0x0c5681), LV_PART_ITEMS|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_main_stop(ui->screen_1_btnm_1, 0, LV_PART_ITEMS|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_grad_stop(ui->screen_1_btnm_1, 255, LV_PART_ITEMS|LV_STATE_DEFAULT);
	lv_obj_set_style_shadow_width(ui->screen_1_btnm_1, 1, LV_PART_ITEMS|LV_STATE_DEFAULT);
	lv_obj_set_style_shadow_color(ui->screen_1_btnm_1, lv_color_hex(0x090a0a), LV_PART_ITEMS|LV_STATE_DEFAULT);
	lv_obj_set_style_shadow_opa(ui->screen_1_btnm_1, 255, LV_PART_ITEMS|LV_STATE_DEFAULT);
	lv_obj_set_style_shadow_spread(ui->screen_1_btnm_1, 1, LV_PART_ITEMS|LV_STATE_DEFAULT);
	lv_obj_set_style_shadow_ofs_x(ui->screen_1_btnm_1, 0, LV_PART_ITEMS|LV_STATE_DEFAULT);
	lv_obj_set_style_shadow_ofs_y(ui->screen_1_btnm_1, 2, LV_PART_ITEMS|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->screen_1_btn_2, 108, 278);
	lv_obj_set_size(ui->screen_1_btn_2, 30, 30);
	...
	lv_obj_set_style_radius(ui->screen_1_btn_2, 30, LV_PART_MAIN|LV_STATE_DEFAULT);
