...
void setup_scr_param(lv_ui *ui)
{
	...
	lv_obj_set_style_text_line_space(ui->param_label_2, 27, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_line_space(ui->param_label_3, 27, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_pad_top(ui->param_label_3, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_label_set_text(ui->param_label_4, "     功        率: ");
	...
	lv_obj_set_style_text_line_space(ui->param_label_4, 27, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_pad_top(ui->param_label_4, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_line_space(ui->param_label_5, 27, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_pad_top(ui->param_label_5, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
