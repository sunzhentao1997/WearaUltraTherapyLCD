...
static void main_paging_event_handler(lv_event_t *e)
{
	...
	if (ScreenState != WORK)
	{
		...
		case LV_EVENT_CLICKED:
		{
			...
			ui_load_scr_animation(&guider_ui, &guider_ui.config, guider_ui.config_del, &guider_ui.main_del, setup_scr_config, LV_SCR_LOAD_ANIM_FADE_ON, 0, 0, false, false);
...
static void main_switch2_event_handler(lv_event_t *e)
{
	...
	case LV_EVENT_CLICKED:
	{
		...
		lv_obj_set_style_text_font(guider_ui.main_change, &lv_customer_font_NSHBold_50, 0);
		lv_obj_add_flag(guider_ui.main_suo, LV_OBJ_FLAG_HIDDEN);
		lv_label_set_text(guider_ui.main_UltraPower, "600");
...
static void main_switch1_event_handler(lv_event_t *e)
{
	...
	case LV_EVENT_CLICKED:
	{
		...
		lv_obj_add_flag(guider_ui.main_ulock, LV_OBJ_FLAG_HIDDEN);
		lv_obj_add_flag(guider_ui.main_suo, LV_OBJ_FLAG_HIDDEN);
		lv_label_set_text(guider_ui.main_UltraPower, "230");
		lv_label_set_text(guider_ui.main_label_3, "剩余治疗时间 ");
...
static void config_save_event_handler(lv_event_t *e)
{
	...
	case LV_EVENT_CLICKED:
	{
		ui_load_scr_animation(&guider_ui, &guider_ui.success, guider_ui.success_del, &guider_ui.config_del, setup_scr_success, LV_SCR_LOAD_ANIM_NONE, 0, 0, false, true);
		break;
	}
	case LV_EVENT_PRESSED:
	{
...
static void param_btn_1_event_handler(lv_event_t *e)
{
	...
	case LV_EVENT_CLICKED:
	{
		...
		ui_load_scr_animation(&guider_ui, &guider_ui.success, guider_ui.success_del, &guider_ui.param_del, setup_scr_success, LV_SCR_LOAD_ANIM_NONE, 0, 0, false, true);
		break;
	}
	case LV_EVENT_PRESSED:
	{
...
static void light_btn_1_event_handler(lv_event_t *e)
{
	...
	case LV_EVENT_CLICKED:
	{
		...
		ui_load_scr_animation(&guider_ui, &guider_ui.success, guider_ui.success_del, &guider_ui.light_del, setup_scr_success, LV_SCR_LOAD_ANIM_NONE, 0, 0, false, true);
		break;
	}
	case LV_EVENT_PRESSED:
	{
...
static void freq_btn_1_event_handler(lv_event_t *e)
{
	...
	case LV_EVENT_CLICKED:
	{
		...
		ui_load_scr_animation(&guider_ui, &guider_ui.success, guider_ui.success_del, &guider_ui.freq_del, setup_scr_success, LV_SCR_LOAD_ANIM_NONE, 0, 0, false, true);
		break;
	}
	case LV_EVENT_PRESSED:
	{
...
static void vibra_btn_1_event_handler(lv_event_t *e)
{
	...
	case LV_EVENT_CLICKED:
	{
		...
		ui_load_scr_animation(&guider_ui, &guider_ui.success, guider_ui.success_del, &guider_ui.vibra_del, setup_scr_success, LV_SCR_LOAD_ANIM_NONE, 0, 0, false, true);
		break;
	}
	case LV_EVENT_PRESSED:
	{
