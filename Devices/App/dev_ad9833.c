...
uint16_t AD9833_FSYNC_GPIO[AD9833_MaxCh] = {B_FSYNC_Pin,B_FSYNC_Pin};
uint16_t AD9833_SCLK_GPIO[AD9833_MaxCh] =  {B_SDATA_Pin,B_SDATA_Pin};
uint16_t AD9833_DATA_GPIO[AD9833_MaxCh] = {B_SCLK_Pin,B_SCLK_Pin};

GPIO_TypeDef* AD9833_FSYNC_PORT[AD9833_MaxCh] = {B_FSYNC_GPIO_Port,B_FSYNC_GPIO_Port};
GPIO_TypeDef* AD9833_SCLK_PORT[AD9833_MaxCh] = {B_SDATA_GPIO_Port,B_SDATA_GPIO_Port};
GPIO_TypeDef* AD9833_DATA_PORT[AD9833_MaxCh] = {B_SCLK_GPIO_Port,B_SCLK_GPIO_Port};
...
static void AD9833_SendData(uint8_t ch,uint32_t txdata)
{
	...
	AD9833_FSYNCSet(ch,GPIO_PIN_RESET);
	...
	for(tag_i=0;tag_i<16;tag_i++){
		if (txdata & 0x8000){
			...
			AD9833_SDATASet(ch,GPIO_PIN_RESET);
		}
		AD9833_Delay();
		AD9833_SCLKSet(ch,GPIO_PIN_RESET);
		AD9833_Delay();
		AD9833_SCLKSet(ch,GPIO_PIN_SET);
		txdata<<=1;
	}
