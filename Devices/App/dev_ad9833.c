...
uint16_t AD9833_SCLK_GPIO[AD9833_MaxCh] =  {A_SDATA_Pin,B_SDATA_Pin};
uint16_t AD9833_DATA_GPIO[AD9833_MaxCh] = {A_SCLK_Pin,B_SCLK_Pin};

GPIO_TypeDef* AD9833_FSYNC_PORT[AD9833_MaxCh] = {A_FSYNC_GPIO_Port,B_FSYNC_GPIO_Port};
GPIO_TypeDef* AD9833_SCLK_PORT[AD9833_MaxCh] = {A_SDATA_GPIO_Port,B_SDATA_GPIO_Port};
GPIO_TypeDef* AD9833_DATA_PORT[AD9833_MaxCh] = {A_SCLK_GPIO_Port,B_SCLK_GPIO_Port};
