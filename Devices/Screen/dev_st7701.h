#ifndef __DEV_ST7701_H
#define __DEV_ST7701_H
...
#define ST7701_SDA(x)		do{ x ? \
														 HAL_GPIO_WritePin(LCD_SPI_SDL_GPIO_Port, LCD_SPI_SDL_Pin, GPIO_PIN_SET) : \
														 HAL_GPIO_WritePin(LCD_SPI_SDL_GPIO_Port, LCD_SPI_SDL_Pin, GPIO_PIN_RESET); \
											  }while(0) 
...
#define ST7701_READ		HAL_GPIO_ReadPin(LCD_SPI_SDL_GPIO_Port, LCD_SPI_SDL_Pin) /* 输入SDA */
