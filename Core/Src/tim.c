...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM2_MspPostInit 0 */
    ...
    PA15     ------> TIM2_CH1
    */
    GPIO_InitStruct.Pin = WAVE_B_EN_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM2;
    HAL_GPIO_Init(WAVE_B_EN_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM9_MspPostInit 0 */
    ...
    PE6     ------> TIM9_CH2
    */
    GPIO_InitStruct.Pin = PWM_BEEP_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF3_TIM9;
    HAL_GPIO_Init(PWM_BEEP_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM12_MspPostInit 0 */
    ...
    PB14     ------> TIM12_CH1
    */
    GPIO_InitStruct.Pin = PWM_MOTOR_B_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF9_TIM12;
    HAL_GPIO_Init(PWM_MOTOR_B_GPIO_Port, &GPIO_InitStruct);
