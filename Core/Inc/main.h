...
#define PWM_BEEP_Pin GPIO_PIN_6
#define PWM_BEEP_GPIO_Port GPIOE
#define LCD_RESET_Pin GPIO_PIN_9
#define LCD_RESET_GPIO_Port GPIOF
#define KEY_CONTROL_Pin GPIO_PIN_0
#define KEY_CONTROL_GPIO_Port GPIOA
#define CONTROL_CLOSE_Pin GPIO_PIN_1
#define CONTROL_CLOSE_GPIO_Port GPIOA
#define LCD_BL_Pin GPIO_PIN_2
#define LCD_BL_GPIO_Port GPIOA
#define CHARGE_STATE_Pin GPIO_PIN_5
...
#define PWM_MOTOR_B_Pin GPIO_PIN_14
#define PWM_MOTOR_B_GPIO_Port GPIOB
