...
#define LCD_SPI_SDL_Pin GPIO_PIN_15
#define LCD_SPI_SDL_GPIO_Port GPIOB
...
#define A_SCLK_Pin GPIO_PIN_6
#define A_SCLK_GPIO_Port GPIOD
#define A_SDATA_Pin GPIO_PIN_7
#define A_SDATA_GPIO_Port GPIOD
#define A_FSYNC_Pin GPIO_PIN_9
#define A_FSYNC_GPIO_Port GPIOG
