...
void setup_scr_main(lv_ui *ui)
{
    ...
    lv_obj_set_style_text_font(ui->main_lowpower, &lv_font_montserratMedium_16, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->main_battery, &lv_font_NSHRegular_18, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_img_recolor_opa(ui->main_battery, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
