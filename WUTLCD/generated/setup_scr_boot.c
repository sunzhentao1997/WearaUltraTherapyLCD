...
void setup_scr_boot(lv_ui *ui)
{
    ...
    lv_obj_set_style_bg_color(ui->boot, lv_color_hex(0x114C8b), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->boot_label_1, &lv_font_alimama_28, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->boot_label_2, &lv_font_NSHRegular_18, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->boot_label_3, &lv_font_Alibaba_25, LV_PART_MAIN|LV_STATE_DEFAULT);
