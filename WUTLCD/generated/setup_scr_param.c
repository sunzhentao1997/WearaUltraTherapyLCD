...
void setup_scr_param(lv_ui *ui)
{
    ...
    lv_obj_set_style_text_font(ui->param_logo, &lv_font_NSHBold_36, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->param_lowpower, &lv_font_montserratMedium_16, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->param_battery, &lv_font_NSHRegular_18, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->param_grate4, &lv_font_NSHRegular_18, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->param_grate3, &lv_font_NSHRegular_18, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->param_grate2, &lv_font_NSHRegular_18, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->param_grate1, &lv_font_NSHRegular_18, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->param_label_1, &lv_font_NSHRegular_24, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->param_label_2, &lv_font_NSHRegular_33, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui->param_label_3, "      软件发布版本:                             TFB-ULT-v1.0 ");
    ...
    lv_obj_set_style_text_font(ui->param_label_3, &lv_font_NSHRegular_33, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->param_label_4, &lv_font_NSHRegular_33, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->param_label_5, &lv_font_NSHRegular_33, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->param_label_6, &lv_font_NSHRegular_33, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->param_back, &lv_font_NSHBold_30, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui->param_DeviceId_label, "2222222225");
    ...
    lv_obj_set_style_text_font(ui->param_DeviceId, &lv_font_NSHRegular_33, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->param_Power, &lv_font_NSHRegular_33, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->param_Temp, &lv_font_NSHRegular_33, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->param_btn_1, &lv_font_NSHBold_30, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->param_btnm_1, &lv_font_NSHRegular_33, LV_PART_ITEMS|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->param_btnm_1, &lv_font_Abel_regular_20, LV_PART_ITEMS|LV_STATE_PRESSED);
    ...
    lv_obj_set_style_text_font(ui->param_back_p, &lv_font_NSHRegular_33, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->param_label_7, &lv_font_NSHRegular_33, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->param_Del, &lv_font_NSHRegular_33, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->param_label_10, &lv_font_NSHRegular_18, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->param_label_9, &lv_font_AlibabaMed_50, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->param_label_8, &lv_font_NSHRegular_18, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->param_btn_2, &lv_font_NSHBlack_43, LV_PART_MAIN|LV_STATE_DEFAULT);
