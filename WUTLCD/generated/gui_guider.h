...
typedef struct
{
	...
	lv_obj_t *config_grate2;
	lv_obj_t *config_grate1;
	...
	lv_obj_t *param_grate2;
	lv_obj_t *param_grate1;
	...
	lv_obj_t *param_label_10;
	lv_obj_t *param_label_9;
	lv_obj_t *param_label_8;
	...
	lv_obj_t *light_grate2;
	lv_obj_t *light_grate1;
	...
	lv_obj_t *vibra_grate2;
	lv_obj_t *vibra_grate1;
	...
	lv_obj_t *vibras_grate2;
	lv_obj_t *vibras_grate1;
	...
	lv_obj_t *freq_grate2;
	lv_obj_t *freq_grate1;
	...
	lv_obj_t *charge_grate1;
	lv_obj_t *charge_grate2;
	lv_obj_t *charge_grate3;
	lv_obj_t *charge_grate4;
...
LV_FONT_DECLARE(lv_font_NSHBold_36)
LV_FONT_DECLARE(lv_font_montserratMedium_16)
LV_FONT_DECLARE(lv_font_montserratMedium_12)
LV_FONT_DECLARE(lv_font_NSHRegular_25)
LV_FONT_DECLARE(lv_font_NSHMedium_40)
LV_FONT_DECLARE(lv_font_alimama_70)
LV_FONT_DECLARE(lv_font_NSHRegular_18)
LV_FONT_DECLARE(lv_font_NSHBold_40)
LV_FONT_DECLARE(lv_font_alimama_45)
LV_FONT_DECLARE(lv_font_NSHBold_60)
LV_FONT_DECLARE(lv_font_NSHRegular_28)
LV_FONT_DECLARE(lv_font_AlibabaMed_50)
LV_FONT_DECLARE(lv_font_NSHRegular_33)
LV_FONT_DECLARE(lv_font_NSHBold_33)
LV_FONT_DECLARE(lv_font_NSHBold_30)
LV_FONT_DECLARE(lv_font_NSHBold_45)
LV_FONT_DECLARE(lv_font_NSHRegular_24)
LV_FONT_DECLARE(lv_font_Abel_regular_20)
LV_FONT_DECLARE(lv_font_NSHBlack_43)
LV_FONT_DECLARE(lv_font_NSHRegular_36)
LV_FONT_DECLARE(lv_font_NSHRegular_48)
LV_FONT_DECLARE(lv_font_NSHRegular_60)
LV_FONT_DECLARE(lv_font_NSHRegular_50)
LV_FONT_DECLARE(lv_font_alimama_28)
LV_FONT_DECLARE(lv_font_Alibaba_25)
